...
class Roseira : public Planta{
    ...
    static const int absorcao_nutrientes = Settings::Roseira::absorcao_nutrientes;
    ...
    static const int multiplica_nutrientes_maior = Settings::Roseira::multiplica_nutrientes_maior;
